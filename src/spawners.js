...
// spawners are responsible for live creation of a character ships & characteristics
//here we control every ship's qualities for this game
//define each ship's strengths and weaknesses
//we can position objects accordingly
export const spawners = (() => {
  ...
  //Code for Boss's ship turrents,
  //Boss ship turrent's health strength
  //Boss ship turrent's blaster strength
  //Adding turrent into the scene, camera and action positioned
  //Boss ship turrent's rendered components
  ...
  //When a ship gets hit, smoke should be visible
  ...
  //When a ship's health drops below zero(0), ship must explode
  ...
  //When a Boss ship's turrent health drops below zero(0), Boss ship's turrent must explode
