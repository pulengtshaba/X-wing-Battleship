...
//Enemy ship indicator, which ships to destroy
  class FloatingDescriptor extends entity.Component {
    ...
    OnCreateSprite_(msg) {
      ...
      //distance of the discriptor from the ship
      const offset = -5;
      ...
      //discriptor should be red on the outside
      ...
      this.context2d_.arc(
          ...
          0, 2 * Math.PI);
      //discriptor should have a yellow plus sign on it, as a badge
      this.context2d_.strokeStyle = '#ffff00';
      ...
      this.context2d_.stroke();
      //below the discriptor, green text should be visible "DESTROY"
      this.context2d_.fillStyle = '#00ff00';
